  ...
  return (
   ...
   <><span ><i className="d-inline fa-solid fa-graduation-cap fa-3x"></i></span><h2 className='d-inline '>Education</h2></>
    ...
    <Row className='mt-5'>
       ...
       <Col md={9}><h5>Full Stack Web Development</h5><p>Udemy/Meta Coursera Full stack web development online Course</p></Col>
      <Col md={3}><h6 className='p-3 mb-2 bg-danger text-white rounded-pill text-center'>2019-</h6></Col>
      <hr/>
